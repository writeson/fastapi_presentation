...
async def create_media_type(media_type: MediaTypeCreate, db: AsyncSession = Depends(get_db)):
    async with db as session:
        return await media_type_crud.create_media_type(session=session, media_type=media_type)
